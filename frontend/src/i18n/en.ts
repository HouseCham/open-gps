export const en = {
    ...
    settings: {
        ...
        intro: 'Customize how you view and use your tracking workspace.',
        saved: 'Changes saved',
        appearance: 'Appearance',
        appearanceSub:
            'Control the appearance and navigation of the application.',
        theme: 'Theme',
        themeHint: 'Choose the theme that feels most comfortable.',
        light: 'Light',
        dark: 'Dark',
        language: 'Language',
        ...
        motionHint: 'Reduce non-essential transitions and motion.',
        on: 'On',
        off: 'Off',
        display: 'Display',
        displaySub: 'Set the initial values for your tracking views.',
        history: 'Default time range',
        historyHint: 'Used when opening location history.',
        lastHour: 'Last hour',
        lastSixHours: 'Last 6 hours',
        lastDay: 'Last 24 hours',
        lastWeek: 'Last 7 days',
        landing: 'First page after signing in',
        landingHint: 'Choose the section you want to see first.',
        dashboard: 'Dashboard',
        devices: 'Devices',
        density: 'Information density',
        densityHint: 'Control how much content is shown in tables.',
        comfortable: 'Comfortable',
        compact: 'Compact',
        region: 'Region and units',
        regionSub:
            'Adjust dates, times, and measurements to match your context.',
        timezone: 'Time zone',
        timezoneHint: 'Used to display dates and query location history.',
        units: 'Unit system',
        unitsHint: 'Choose how speed, distance, and altitude are displayed.',
        metric: 'Metric',
        imperial: 'Imperial',
        timeFormat: 'Time format',
        timeHint: 'Affects times shown in history and activity.',
        hours12: '12 hours',
        hours24: '24 hours',
        account: 'Account and security',
        accountSub: 'Manage your account details and credentials.',
        profileAction: 'Edit profile',
        profileHint:
            'Update your identity and review personal information from Profile.',
        editProfile: 'Edit profile',
        changePassword: 'Change password',
        email: 'Email address',
        readOnly: 'Read only',
        accountSummary: 'Your account',
        accountSummaryText: 'Personal preferences for your tracking workspace.',
        role: 'Role',
        created: 'Created',
        user: 'User',
        superAdmin: 'Super admin',
        ...
        comingSoonText:
            'Alerts and advanced preferences will be available once these features are connected.',
    ...
    page: {
        ...
        reports: {
            ...
            filters: {
                ...
                lastDay: 'Last 24 hours',
                lastWeek: 'Last 7 days',
                selectedDevices: '2 devices selected',
                allDevices: 'All devices',
                allVehicleTypes: 'All vehicle types',
                timezoneHint: 'Dates are interpreted in this time zone.',
                deviceHint: 'Only devices you can access.',
                retentionNote:
            ...
            overview: {
                title: 'Overview',
                description:
                    'A general view of activity recorded during the selected period.',
                activityTitle: 'Activity over time',
                activityDescription: 'Volume of reports received by device.',
                receivedPoints: 'Received points',
                quickRead: 'Quick read',
                peakActivity: 'Activity peak',
                totalPerHour: 'Total per hour',
                activeDevices: 'Active devices',
                devicesWithActivity: 'Active devices',
                devicesDescription:
                    'Activity and continuity detail for the selected period.',
                viewAll: 'View all',
                device: 'Device',
            ...
            routes: {
                title: 'Routes',
                description:
                    'Explore estimated routes derived from received GPS points.',
                disclaimer:
                    'Distances and stops are estimates based on GPS data.',
                ...
                simplified:
                    'The route shown is simplified for performance; metrics use the complete dataset.',
                interruption: 'This route contains data interruptions.',
            },
            health: {
                title: 'Device health',
                description:
                    'Review available telemetry and report regularity.',
                disclaimer:
                    'Availability depends on device hardware and firmware.',
                recentContact: 'Recent contact',
                noOptionalTelemetry: 'No optional telemetry',
                lastContact: 'Last contact',
                battery: 'Battery voltage',
                averageBattery: 'Average battery',
                signal: 'Cellular signal',
                gpsAccuracy: 'Average GPS accuracy',
                reports: 'Reports',
                missingBattery: 'This device has not sent battery voltage.',
                missingSignal: 'This device has not sent signal strength.',
                telemetryTrend: 'Telemetry trend',
                trendDescription:
                    'Intervals without data are not connected as continuous measurements.',
                batteryMetric: 'Voltage · V',
                signalMetric: 'Signal · CSQ',
                gpsMetric: 'Accuracy · m',
                trendReading: 'Trend reading',
                trendSummary:
                    'Intervals with available telemetry are shown for 2 devices.',
            },
            quality: {
                title: 'Data quality',
                description:
                    'Identify interruptions, incomplete data, and unreliable GPS readings.',
                averageInterval: 'Average report interval',
                largestInterruption: 'Largest interruption',
                incompleteRecords: 'Incomplete records',
                coordinateJumps: 'Coordinate jumps',
                period: 'During the period',
                optionalMissing: 'Optional telemetry missing',
                requiresReview: 'Requires review',
                quality: 'GPS quality',
                state: 'State',
                continuityDisclaimer:
                    'This report describes the continuity of received data; it does not represent an exact device availability history.',
            },
            export: {
                title: 'Export reports',
                description:
                    'The file will respect current filters and permissions. Exports may take longer for broad periods.',
                csv: 'Export CSV',
                gpx: 'Export GPX',
                preparing: 'Preparing {type} export…',
