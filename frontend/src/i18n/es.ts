...
export const es: Translation = {
    ...
    settings: {
        ...
        intro: 'Personaliza cómo ves y usas tu espacio de seguimiento.',
        saved: 'Cambios guardados',
        appearance: 'Apariencia',
        appearanceSub: 'Controla el aspecto de la aplicación y la navegación.',
        theme: 'Tema',
        themeHint: 'Elige el tema que resulte más cómodo para ti.',
        light: 'Claro',
        dark: 'Oscuro',
        language: 'Idioma',
        ...
        motionHint: 'Reduce transiciones y movimientos no esenciales.',
        on: 'Activado',
        off: 'Desactivado',
        display: 'Visualización',
        displaySub:
            'Define los valores iniciales de tus vistas de seguimiento.',
        history: 'Rango temporal predeterminado',
        historyHint: 'Se usará al abrir un historial de ubicaciones.',
        lastHour: 'Última hora',
        lastSixHours: 'Últimas 6 horas',
        lastDay: 'Últimas 24 horas',
        lastWeek: 'Últimos 7 días',
        landing: 'Página inicial después de iniciar sesión',
        landingHint: 'Elige la sección que quieres ver primero.',
        dashboard: 'Panel',
        devices: 'Dispositivos',
        density: 'Densidad de la información',
        densityHint: 'Controla cuánto contenido se muestra en las tablas.',
        comfortable: 'Cómoda',
        compact: 'Compacta',
        region: 'Región y unidades',
        regionSub:
            'Ajusta fechas, horas y medidas para que coincidan con tu contexto.',
        timezone: 'Zona horaria',
        timezoneHint:
            'Se usará para mostrar fechas y consultar el historial de ubicaciones.',
        units: 'Sistema de unidades',
        unitsHint: 'Define cómo se muestran velocidad, distancia y altitud.',
        metric: 'Métrico',
        imperial: 'Imperial',
        timeFormat: 'Formato de hora',
        timeHint: 'Afecta las horas mostradas en el historial y la actividad.',
        hours12: '12 horas',
        hours24: '24 horas',
        account: 'Cuenta y seguridad',
        accountSub: 'Administra los datos de tu cuenta y sus credenciales.',
        profileAction: 'Editar perfil',
        profileHint:
            'Actualiza tu identidad y revisa tu información personal desde Perfil.',
        editProfile: 'Editar perfil',
        changePassword: 'Cambiar contraseña',
        email: 'Correo electrónico',
        readOnly: 'Solo lectura',
        accountSummary: 'Tu cuenta',
        accountSummaryText:
            'Preferencias personales para tu espacio de seguimiento.',
        role: 'Rol',
        created: 'Creada',
        user: 'Usuario',
        superAdmin: 'Super admin',
        reset: 'Restablecer preferencias',
        comingSoon: 'Más preferencias próximamente',
        comingSoonText:
            'Las alertas y preferencias avanzadas estarán disponibles cuando estas funciones estén conectadas.',
    ...
    device: {
        ...
        live: {
            title: 'Rastreo en directo',
            kicker: 'RASTREO EN DIRECTO',
            loading: 'Cargando rastreo en directo…',
            loadingHistory: 'Cargando historial de ubicaciones…',
            failedToLoad: 'No se pudo cargar el rastreo en directo',
            retry: 'Reintentar',
            missingDeviceTitle: 'No se ha seleccionado ningún dispositivo',
            missingDeviceMessage:
                'Abre esta página con un id de dispositivo, por ejemplo ?id=id-del-dispositivo.',
            backToDevices: 'Volver a dispositivos',
            backToDevice: 'Volver al dispositivo',
            liveUpdatesOn: 'Actualizaciones activas',
            liveUpdatesOff: 'Actualizaciones pausadas',
            ...
            liveLocationDescription:
                'La última posición comunicada por este dispositivo.',
            nextPacket: 'Siguiente paquete en',
            updatesPaused: 'Actualizaciones pausadas',
            routeView: 'Vista de ruta',
            routeSubtitle: 'Historial de ubicaciones reciente',
            centerMap: 'Centrar mapa',
            centered: 'El mapa está centrado en el último paquete.',
            livePosition: 'Posición en directo',
            mapLabel: 'Mapa de ubicación en directo',
            noLocation: 'Nunca ha comunicado',
            noLocationDescription:
                'Este dispositivo aún no ha comunicado ninguna ubicación.',
            latestTelemetry: 'Última telemetría',
            latestTelemetrySubtitle: 'Del último paquete de ubicación',
            latitude: 'Latitud',
            longitude: 'Longitud',
            altitude: 'Altitud',
            speed: 'Velocidad',
            ...
            detectiveNote:
                'Usa un intervalo amplio para el historial de ruta. Los resultados están paginados para mantener la línea de tiempo ágil.',
            locationHistory: 'Historial de ubicaciones',
            showing: 'Mostrando las últimas {shown} de {total} entradas',
            export: 'Exportar resultados',
            coordinates: 'Coordenadas',
            source: 'Origen',
            cellular: 'Celular',
            ingestionInterval:
                'Intervalo de ingesta de 15 segundos · más recientes primero',
